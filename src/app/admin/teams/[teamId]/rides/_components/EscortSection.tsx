  ...
  return (
    <div className="pt-3 border-t border-gray-200 space-y-2">
      ...
      {canAddEscort && (
        ...
        className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-teal-200 bg-teal-50 px-3 py-2 text-xs font-semibold text-teal-700 transition hover:bg-teal-100"
        >
          <Plus size={14} />
          <span>引率者を追加</span>
        </button>
