...
本プロダクトは段階的に機能を拡張し、チーム運営全体をサポートするツールを目指しています。

- **フェーズ1**：配車管理機能を中心に、チーム・メンバー・配車の登録・管理を実現する。
- **フェーズ2**：カレンダー表示や通知機能を追加し、利便性を向上させる。
- **フェーズ3**：過去の配車データの分析や、費用の自動計算・精算機能を追加する。
- **フェーズ4**：外部サービス（Googleカレンダー、LINE）との連携機能を追加する。